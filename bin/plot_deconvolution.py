...
cell_colors = {
    ...
    # LINFOCITI T CD8+ E NK ( Viola/Lilla)
    ...
    # MACROFAGI E MONOCITI (Arancione/Marrone)
    ...
    # CELLULE DENDRITICHE E GRANULOCITI (Rosso/Giallo)
...
# correlazione tra i diversi tipi cellulari
corr = df_t.corr()
